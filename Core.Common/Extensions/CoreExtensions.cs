...
namespace Core.Common.Extensions
{
	public static class CoreExtensions
	{
		...
		public static bool IsNavigable(this ClientEntityBase obj, string propertyName)
		{
		...
		public static PropertyInfo[] GetBrowsableProperties(this object obj)
		{
			...
			if (!BrowsablePropertyInfos.ContainsKey(key))
			{
				...
				{
					if ((property.PropertyType.IsSubclassOf(typeof(ClientEntityBase)) || property.PropertyType.GetInterface("IList") != null))
					{
